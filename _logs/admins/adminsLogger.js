...
const logStream = fs.createWriteStream(path.join(__dirname, '_adminsLogs.txt'), { flags: 'a' });
...
const adminsLogs = morgan(customLogger, { stream: logStream });

/*============ EXPORT MODULE ============*/
module.exports = { adminsLogs };